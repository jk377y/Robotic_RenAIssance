				...
				<HomepageSection>
					...
					<SemiTransparentBox>
						...
						<p style={styles.textField}>
							The staff robots at Robotic Rennaissance are
							equipped with advanced AI technology that allows
							them to interact with visitors, answer questions,
							and provide recommendations on art pieces. With
							their precision and efficiency, we can ensure that
							every visitor's needs are met and their experience
							is unforgettable.
						</p>
						<div style={styles.imgRow}>
							<Container>
								<a
									href="https://jk377y.dev"
									target="_blank"
									rel="noreferrer"
								>
									<img
							...
							<Container>
								<a
									href="https://github.com/fabien1313"
									target="_blank"
									rel="noreferrer"
								>
									<img
							...
							<Container>
								<a
									href="https://github.com/sofiasosa92"
									target="_blank"
									rel="noreferrer"
								>
									<img
